        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button asChild variant="ghost" size="sm" className="text-muted-foreground hover:text-foreground">
              <a href={SPECIALIST_URL}>Talk to a Specialist</a>
            </Button>
            <Button asChild size="sm" className="gradient-accent text-primary-foreground font-medium">
              <a href={DEMO_URL}>Request Demo</a>
            </Button>
          </div>
        </div>
      </div>
